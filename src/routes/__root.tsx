...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Nilda Contabilidade — Assessoria contábil em Betim/MG" },
      { property: "og:description", content: "Escritório contábil em Betim/MG desde 1996. Contabilidade, fiscal, tributário, RH e legalização." },
